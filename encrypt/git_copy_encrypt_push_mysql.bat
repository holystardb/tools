...
set source="D:\onenote\OneNote笔记本\MySQL"
set target="D:\github\OneNote笔记本_mysql"
...
files_encrypt_concurrent.exe --c D:\github\encrypt_mysql.ini
